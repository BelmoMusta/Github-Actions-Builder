...
public class XYAMLGenerator extends YAMLGenerator {

    public XYAMLGenerator(IOContext ctxt, int jsonFeatures, int yamlFeatures, StringQuotingChecker quotingChecker,
    ...
    public XYAMLGenerator(IOContext ctxt, int jsonFeatures, int yamlFeatures, StringQuotingChecker quotingChecker,
                          ObjectCodec codec, Writer out, DumperOptions dumperOptions) throws IOException {
    ...
    public void writeString(String text) throws IOException, JsonGenerationException {
        ...
        if (text.isEmpty()) {
            _writeScalar(text, "string", DumperOptions.ScalarStyle.SINGLE_QUOTED);
            return;
        }
